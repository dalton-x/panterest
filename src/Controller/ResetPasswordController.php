...
class ResetPasswordController extends AbstractController
{
    ...
    */
    public function reset(Request $request, UserPasswordEncoderInterface $passwordEncoder, string $token = null): Response
    {
        ...
        if (null === $token) {
            throw $this->createNotFoundException('Aucun token n\'a été trouvé pour réinitilisé le mot de passe.');
        }
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', 'Votre mot de passe a été réinitialisé avec succes. Vous pouvez vous reconnecter avec votre nouveau mot de passe.');
